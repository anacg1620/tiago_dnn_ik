...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /docker-ros/ws/tiago-rl-inference/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /docker-ros/ws/tiago-rl-inference/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /docker-ros/ws/tiago-rl-inference/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/docker-ros/ws/tiago-rl-inference/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /docker-ros/ws/tiago-rl-inference/devel/.private/catkin_tools_prebuild/lib;/opt/ros/noetic/lib)
